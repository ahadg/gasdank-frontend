  ...
  return (
    <Col xxl={4}>
      <Card>
        ...
        <CardBody>
          <ReactApexChart height={286} options={TrafficChartOpts} series={TrafficChartOpts.series} type="radialBar" className="apex-charts" />
          <Row className="mt-2">
            <Col>
              <div className="d-flex justify-content-between align-items-center p-1">
                ...
                <span className="fw-semibold text-muted float-end"><IconifyIcon icon='tabler:arrow-badge-down' className="text-danger" /> 965</span>
              </div>
              <div className="d-flex justify-content-between align-items-center p-1">
                <div>
                ...
                <span className="fw-semibold text-muted float-end"><IconifyIcon icon='tabler:arrow-badge-up' className="text-success" /> 75</span>
              </div>
            </Col>
            <Col>
              <div className="d-flex justify-content-between align-items-center p-1">
                ...
                <span className="fw-semibold text-muted float-end"><IconifyIcon icon='tabler:arrow-badge-up' className="text-success" /> 102</span>
              </div>
              <div className="d-flex justify-content-between align-items-center p-1">
                <div>
                ...
                <span className="fw-semibold text-muted float-end"><IconifyIcon icon='tabler:arrow-badge-down' className="text-danger" /> 96</span>
              </div>
            </Col>
          </Row>
        </CardBody>

    ...
    <Col lg={8}>
      <Card className="card-h-100">
        <CardHeader className="d-flex flex-wrap border-bottom border-dashed align-items-center gap-3">
          <h4 className="header-title me-auto">Patients Statistics <span className="text-muted fw-normal fs-14">(609.5k Patients)</span></h4>
        ...
        <CardBody className="pt-1">
          <div dir="ltr">
            <ReactApexChart height={358} options={PatientsChartOpts} series={PatientsChartOpts.series} type="area" className="apex-charts" />
          </div>
        </CardBody>
      </Card>
    </Col>

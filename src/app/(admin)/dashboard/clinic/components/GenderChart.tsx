    ...
    <Col xxl={'4'}>
      <Card>
        <CardHeader className="d-flex justify-content-between border-bottom border-dashed align-items-center">
          ...
          <Button variant="soft-primary" size="sm">Generate Report <IconifyIcon icon='tabler:file-export' className="ms-1" /></Button>
        </CardHeader>
        <CardBody>
          ...
          <Row className="mt-3">
            <Col sm={'4'} className="text-start">
              ...
              <span className="badge fs-12 badge-soft-danger"><IconifyIcon  icon="tabler:arrow-badge-down" /> 3.91%</span>
            </Col>
            ...
            <Col sm={'4'} className="text-end">
              ...
              <span className="badge fs-12 badge-soft-success"><IconifyIcon  icon="tabler:arrow-badge-up" /> 1.05%</span>
            </Col>
          </Row>
        </CardBody>
      </Card>

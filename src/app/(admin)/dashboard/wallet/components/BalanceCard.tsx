import discoverCardImg from "@/assets/images/cards/discover-white.svg"
import visaCardImg from "@/assets/images/cards/visa-white.svg"
        ...
        <Carousel controls={false} id="carouselExampleIndicators" className="slide carousel-dark" data-bs-ride="carousel">
          <CarouselItem >
            <Card className="bg-primary shadow-none rounded-4">
              <CardBody>
                <span className="float-end text-white-50 display-5 mt-n1"><IconifyIcon icon="tabler:wifi" /></span>
                ...
                <Row className="mt-4 align-items-center">
                  ...
                  <Col xs={4}>
                    <div className="text-end">
                      <Image src={visaCardImg} alt='visaCardImg' height={20} className="me-1" />
                    </div>
                  </Col>
                </Row>
              </CardBody>
            ...
            <div className="d-flex justify-content-between align-items-center mb-2">
              <div>
                ...
                <h4 className="fs-18">{currency}38562.25 <small className="text-muted">USD</small></h4>
              </div>
          ...
          <CarouselItem>
            <Card className="bg-success rounded-4">
              <CardBody>
                <span className="float-end text-white-50 display-5 mt-n1"><i className="ti ti-wifi" /></span>
                <h4 className="text-white">Mr. Dhanoo K</h4>
                <Row className="align-items-center mt-4">
                  <Col xs={3} className="text-white fs-10">
                    <IconifyIcon icon="tabler:circle-filled" />
                ...
                <Row className="mt-4 align-items-center">
                  ...
                  <Col xs={4}>
                    <div className="text-end">
                      <Image src={discoverCardImg} alt='discoverCardImg' height={16} className="me-1" />
                    </div>
                  </Col>
                </Row>
              </CardBody>

      ...
      <Col xl={4}>
        <Card>
          <div className="d-flex card-header justify-content-between align-items-center">
            ...
            <Dropdown >
              <DropdownToggle as={'a'} className="bg-light-subtle rounded drop-arrow-none card-drop" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <CardBody className="pt-0">
            <h2 className="fw-bold">{currency}92,652.36 <Link href="" className="text-muted icons-center"><IconifyIcon icon='tabler:eye' /></Link></h2>
            <Row className="g-2 mt-2 pt-1">
              <Col>
                <Button variant="primary" className="w-100"><IconifyIcon icon='tabler:coin' className=" me-1" /> Transfer</Button>
              </Col>
              <Col>
                <Button variant="info" className="w-100"><IconifyIcon icon='tabler:coin' className=" me-1" /> Request</Button>
              </Col>
            </Row>
          </CardBody>
        </Card>
          ...
          <CardBody>
            <Row className="justify-content-between">
              <Col sm={4}>
                ...
                <span className="badge fs-12 badge-soft-danger"><IconifyIcon icon="tabler-arrow-badge-down" /> 0.93%</span>
              </Col>
          ...
          <CardBody>
            <Row className="justify-content-between">
              <Col sm={4}>
                ...
                <span className="badge fs-12 badge-soft-success"><IconifyIcon icon="tabler:arrow-badge-up" /> 8.72%</span>
              </Col>
              <Col sm={7} className="text-end d-flex flex-column">
                <Link href="" className="link-reset text-decoration-underline link-offset-2 fw-medium pb-2">
                  View Details
                ...
                <div className="text-end mt-auto">
                  ...
                  <ReactApexChart height={60} options={expenseOpts} series={expenseOpts.series} type="bar" className="apex-charts" />
                </div>
              </Col>
            </Row>
          </CardBody>

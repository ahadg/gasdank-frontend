                    ...
                    <Table className="text-center table-nowrap align-middle mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <Form.Control type="number" className=" w-auto" placeholder={`${currency}0.00`} />
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td className="text-end">
                            <div className="ms-auto" style={{ width: 160 }}>
                              <Form.Control type="number" id="productSubtotal" placeholder={`${currency}0.00`} />
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className="text-end">
                            <div className="ms-auto" style={{ width: 160 }}>
                              <Form.Control type="number" id="productShipping" placeholder={`${currency}0.00`} />
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className="text-end">
                            <div className="ms-auto" style={{ width: 160 }}>
                              <Form.Control type="number" id="productDiscount" placeholder={`${currency}0.00`} />
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td className="text-end">
                            <div className="ms-auto" style={{ width: 160 }}>
                              <Form.Control type="number" id="productTaxes" placeholder={`${currency}0.00`} />
                            </div>
                          </td>
                        </tr>
                        <tr className="fs-15">
                          ...
                          <th className="text-end">
                            <div className="ms-auto" style={{ width: 160 }}>
                              <Form.Control type="number" id="productTotalAmount" disabled placeholder={`${currency}0.00`} />
                            </div>
                          </th>
                        </tr>
                      </tbody>

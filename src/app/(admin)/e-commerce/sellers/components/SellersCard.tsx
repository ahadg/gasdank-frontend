      ...
      <CardBody>
        <div className="d-flex flex-wrap gap-2 align-items-center">
          <div className="avatar-xl bg-light d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
            <Image src={image} alt='seller' className="avatar-lg h-auto w-auto flex-shrink-0" />
          </div>
          <div>
        ...
        <p className="mb-1 fw-medium  d-flex align-items-center gap-2"><IconifyIcon icon="solar:map-point-search-bold" className="fs-20 text-danger" /> : <span className="fw-medium">{location},</span></p>
        <p className="mb-3 text-dark fw-medium  d-flex align-items-center gap-2"><IconifyIcon icon="solar:letter-bold" className="fs-20 text-danger" /> : <Link href="" className="link-primary fw-medium">{email}</Link></p>
        ...
        <Row className="align-items-center justify-content-between my-4 text-center">
          <Col lg={8} className="border-end">
            <ReactApexChart height={100} options={sellersChartOpts} series={sellersChartOpts.series} type="area" className="apex-charts pe-lg-3" />
          </Col>
          <Col lg={4}>
        ...
        <div className="gap-1 hstack">
          <Button variant='primary' className="w-100">Show Profile</Button>
          <Button variant='light' className="w-100">Edit Profile</Button>
        </div>
      </CardBody>
    </Card>
  )

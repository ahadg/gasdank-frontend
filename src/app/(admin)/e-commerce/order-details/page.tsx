        ...
        <Row className="align-items-start justify-content-between">
          <Col lg={5}>
            <p className="text-dark fw-medium fs-15 d-flex align-items-center gap-1 mb-2">
              ...
              <span className="badge bg-light-subtle rounded-pill text-dark border fs-12 py-1 px-2">
                #OC3142-EN
              </span>
            </p>
            <h3 className="mb-1 text-dark fw-semibold">Order ID : #OC3142-EN <span className="badge bg-warning-subtle rounded-pill text-warning border border-warning fs-11 py-1 px-2 my-2">Shipping</span> <span className="badge bg-success-subtle rounded-pill text-success border border-success fs-11 py-1 px-2  my-2"> No Action Needed</span></h3>
            <div className="d-flex flex-wrap align-items-center gap-2">
              <p className="mb-0 fs-15">Order Date : 2 July 2024</p>
              <div>|</div>
              <div>
                <p className="mb-0 fs-15 text-success fw-medium  d-flex align-items-center gap-1"><IconifyIcon icon="tabler:plane-tilt" />Estimated delivery: July 9, 2024</p>
              </div>
            </div>
          </Col>
  ...
  return (
    <Card>
      <CardHeader className="border-bottom">
        <CardTitle as={'h5'} className="mb-0">Timeline</CardTitle>
      </CardHeader>
      <CardBody>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p className="mb-0 fs-14 fw-medium text-muted">Coderthemes <IconifyIcon icon="solar:verified-check-bold" className="align-middle text-success" /></p>
                </td>
              </tr>
            </tbody>
          </table>
...
const ShipmentCard = () => {
  return (
    <Card>
      <CardHeader className="border-bottom">
        <CardTitle as={'h5'} className="mb-0">Shipment &amp; Details</CardTitle>
      </CardHeader>
      <CardBody>
        <div className="d-flex align-items-center gap-2">
          <div className="avatar-lg bg-light d-flex align-items-center justify-content-center rounded">
            <Image src={digitalOceanImg} alt='digitalOceanImg' className="avatar-md" />
          </div>
          <div>
        ...
        <Row className="justify-content-between mt-4">
          ...
          <Col lg={7}>
            ...
            <span className="badge bg-light-subtle rounded-pill text-dark border fs-13 fw-medium py-1 px-2 ">#PY26356-NT <Link href="" className="ms-1"><IconifyIcon icon='tabler:copy' /></Link></span>
          </Col>
        </Row>
      </CardBody>
    </Card>
    ...
    <Card>
      <CardBody>
        <div className="mapouter">
          <div className="gmap_canvas"><iframe className="gmap_iframe rounded" width="100%" style={{ height: 264 }} frameBorder={0} scrolling="no" marginHeight={0} marginWidth={0} src="https://maps.google.com/maps?width=1980&height=400&hl=en&q=University of Oxford&t=&z=14&ie=UTF8&iwloc=B&output=embed" /></div>
        </div>
      </CardBody>
    </Card>
  )
...
const OrderItemsCard = () => {
  return (
    <Card>
      <CardHeader className="border-bottom">
        <CardTitle as={'h5'} className="mb-0">Order Items</CardTitle>
      </CardHeader>
      <CardBody>
        <Row className="g-3">
          {
              ...
              <Col lg={6} key={idx}>
                <div className="d-flex align-items-center border border-dashed rounded p-2 gap-3">
                  <div className="rounded bg-light avatar-xl d-flex align-items-center justify-content-center">
                    <Image src={item.image} alt='product' className="avatar-xl" />
                  </div>
                  <div>
                    <Link href="" className="text-dark fw-medium fs-15">{item.title}</Link>
                    <p className="text-muted fw-medium fs-14 my-1"><span className="text-dark">Price : </span> ${item.price}</p>
                    <p className="text-muted fw-medium fs-14 my-1"><span className="text-dark">Size : </span>{item.size}</p>
                  </div>
                </div>
              </Col>
            ))

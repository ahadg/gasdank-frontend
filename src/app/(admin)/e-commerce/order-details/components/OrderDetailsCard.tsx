      ...
      <CardBody>
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2">
          <div className="avatar-lg bg-light d-flex align-items-center justify-content-center rounded  flex-shrink-0">
            <Image src={masterCardImg} alt="Card Img" className="img-fluid" />
          </div>
          <div>
    ...
    <Card>
      <CardBody>
        ...
        <div className="d-flex flex-wrap align-items-center mt-3 mb-2 justify-content-between gap-2">
          <div>
            <span className="badge bg-light-subtle rounded-pill text-dark border fs-13 fw-medium py-1 px-2 d-flex align-items-center gap-1"><IconifyIcon icon='tabler:plane-tilt' className="text-warning" /> 613 Kuhl Avenue</span>
          </div>
          <IconifyIcon icon='tabler:arrow-narrow-right' className="fs-18 text-muted" />
          <div>
            <span className="badge bg-light-subtle rounded-pill text-dark border fs-13 fw-medium py-1 px-2 d-flex align-items-center gap-1"><IconifyIcon icon="solar:map-point-bold-duotone" className="fs-18 text-warning" /> 1890 Uitsig St Grahamstad USA</span>
          </div>
        </div>
        <div className="progress flex-grow-1" role="progressbar" aria-label="Basic example" aria-valuenow={0} aria-valuemin={0} aria-valuemax={100} style={{ height: 10 }}>

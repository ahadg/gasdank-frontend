        ...
        <div className="d-flex align-items-start justify-content-between gap-2">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <Dropdown align={'end'} className="flex-shrink-0 text-muted">
              <DropdownToggle as={'a'} href="#" className="drop-arrow-none fs-20 link-reset p-0" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <DropdownMenu className="dropdown-menu-end">
                ...
                <DropdownItem href={avatar1.src} download className="dropdown-item"><IconifyIcon icon='tabler:download' className="me-1" /> Download</DropdownItem>
                ...
                <DropdownItem data-dismissible="#googleMedia"><IconifyIcon icon='tabler:trash' className="me-1" /> Delete</DropdownItem>
              </DropdownMenu>
            </Dropdown>
          </div>
        </div>
        <div className="flex-grow-1 mt-3">
          <h5 className="mb-1"><Link href="" className="link-reset">{title}</Link></h5>
      ...
      <div className="p-3">
        <div className="d-flex align-items-center gap-1 mb-3">
          <div className="flex-shrink-0 d-xl-none d-inline-flex">
            <button onClick={toggle} className="btn btn-sm btn-icon btn-soft-primary align-items-center p-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#fileManagerSidebar" aria-controls="fileManagerSidebar">

  ...
  return (
    <Card>
      <CardHeader className="border-bottom border-dashed">
        <CardTitle as={'h4'} className="mb-0">Medical Information</CardTitle>
      </CardHeader>
      <CardBody>
        <Row className="g-3">
          <Col lg={6}>
            <div>
              <label htmlFor="bloodGroup" className="form-label">Patient Blood Group</label>
              <Form.Control type="text" id="bloodGroup" placeholder="Enter Blood group" />
            </div>
          </Col>
          <Col lg={6}>
            <div>
              <label htmlFor="bloodPressure" className="form-label">Patient Blood Pressure</label>
              <Form.Control type="text" id="bloodPressure" placeholder="Enter Blood pressure" />
            </div>
          </Col>
          <Col lg={6}>
            <div>
              <label htmlFor="sugarLevel" className="form-label">Patient Sugar Level</label>
              <Form.Control type="text" id="sugarLevel" placeholder="Enter Sugar level" />
            </div>
          </Col>
          <Col lg={6}>
            <div>
              <label htmlFor="condition" className="form-label">Patient Condition</label>
              <Form.Control type="text" id="condition" placeholder="Condition" />
            </div>
          </Col>
        </Row>
      </CardBody>

    ...
    <Card>
      <CardBody className="text-center">
        <Row className="justify-content-between mb-3">
          ...
          <Col lg={4} xs={4}>
            <Image src={image} alt="avatar" className="avatar-xl rounded" />
          </Col>
        ...
        <div className="mt-3 d-flex gap-2 justify-content-center">
          <Button variant="soft-danger"
                  className="d-inline-flex align-items-center justify-content-center rounded avatar-md "><span> <IconifyIcon
            icon="solar:chat-round-call-bold-duotone" className="fs-22" /></span></Button>
          <Button variant="soft-primary"
                  className="d-inline-flex align-items-center justify-content-center rounded avatar-md ">
            <span> <IconifyIcon icon="solar:outgoing-call-rounded-bold-duotone" className="fs-22" /></span> </Button>
          <Button variant="soft-success"
                  className="d-inline-flex align-items-center justify-content-center rounded avatar-md ">
            <span> <IconifyIcon icon="solar:videocamera-bold-duotone" className="fs-22" /></span></Button>
        </div>
        <div className="text-start mt-3">
          <p className="mb-1 fw-medium fs-14  d-flex align-items-center">Location : <span
            className="fs-13 ms-auto fw-normal">{location}</span></p>
          <p className="mb-0 fw-medium fs-14  d-flex align-items-center">Email Address : <Link href=""
                                                                                               className="fs-13 ms-auto fw-normal">{email}</Link>
          </p>
        </div>
      </CardBody>
      <CardFooter className="border-top border-dashed gap-1 hstack">
        <Button variant="outline-primary" className="w-100">Show Services</Button>
...
export const metadata: Metadata = { title: 'Hospital Contacts' }

const ContactsPage = async () => {
  const contactData = await getAllDoctorList()
  return (
    <>

        ...
        <Card>
          <CardHeader className="d-flex align-items-center justify-content-between border-bottom border-light">
            ...
            <div className="d-flex flex-wrap gap-1">
              <Button variant='success' className="bg-gradient"><IconifyIcon icon='tabler:plus' className="me-1" /> New Appointment</Button>
                    ...
                    appointmentData.map((item, idx) => (
                      <tr key={idx}>
                        ...
                        <td>
                          {
                            item.doctors.image &&
                            <Image src={item.doctors.image} alt='avatar' className="avatar-sm rounded-circle me-2" />
                          }
                          {item.doctors.name}</td>

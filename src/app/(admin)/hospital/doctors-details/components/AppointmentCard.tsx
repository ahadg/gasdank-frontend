  ...
  return (
    <Card>
      <form onSubmit={handleSubmit(() => { })}>
        <CardBody>
          <CardTitle as={'h4'} className="mb-3">Appointment :</CardTitle>
          <div className="border border-dashed bg-light bg-opacity-10 p-3 rounded">
            ...
            <div className="mb-2">
              <label htmlFor="schedule-time" className="form-label">Time</label>
              <CustomFlatpickr
                className="form-control"
        ...
        <CardFooter className="border-top">
          <Button variant='primary' type='submit' className="w-100">Book Appointment</Button>
        </CardFooter>
      </form>
    </Card>
  )

    ...
    <Card>
      <CardBody>
        <div className="dr-profile-bg rounded-top position-relative mx-n3 mt-n3 position-relative">
          <Image src={avatar3} alt='avatar' className="border border-light border-3 rounded-circle position-absolute top-100 start-50 translate-middle" height={100} width={100} />
        </div>
        ...
        <CardTitle as={'h5'} className="fw-semibold">About Doctor :</CardTitle>
        <p className="mt-2">Dr. James Roger has vast experience in treating cardiovascular diseases. He has presented papers at national and international levels. Currently, he is a Professor and Head at a Medical College specializing in Cardiology.</p>
        <div className="mt-3">
          <Row>
            <Col lg={3} xs={3}>
              <h5>Operations</h5>
        ...
        <CardTitle as={'h5'} className="fw-semibold mt-4 mb-2">Doctor Level :</CardTitle>
        ...
        <CardTitle as={'h5'} className="fw-semibold mt-4">Doctor Rating :</CardTitle>
      ...
      <CardFooter className="border-top gap-1 hstack">
        ...
        <Button variant="light" className="w-100">Follow</Button>

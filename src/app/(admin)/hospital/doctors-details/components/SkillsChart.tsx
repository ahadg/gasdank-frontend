  ...
  return (
    <Card>
      <CardHeader className="border-bottom border-dashed">
        <CardTitle as={'h4'} className="mb-0">Specialty</CardTitle>
      </CardHeader>
      <CardBody>
        {
  ...
  return (
    <Row>
      <Col lg={6}>
        <Card>
          <CardHeader className="border-bottom border-dashed">
            <CardTitle as={'h4'} className="mb-0">Skills</CardTitle>
          </CardHeader>
          <CardBody>
            <ReactApexChart height={338} options={SkillsChartOpts} series={SkillsChartOpts.series} type="radialBar" className="apex-charts" />
          </CardBody>
        </Card>
      </Col>
      <Col lg={6}>

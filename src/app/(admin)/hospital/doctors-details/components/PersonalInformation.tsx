  ...
  return (
    <Card>
      <CardBody>
                ...
                <table className="table table-borderless m-0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="px-2 text-dark fw-medium fs-14"><Link href="">www.coderthemes.com </Link></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <CardTitle as={'h4'}>Abilities :</CardTitle>
              {
                abilitiesData.map((item, idx) => (
                  <Fragment key={idx}>
                    ...
                    <ProgressBar variant={item.variant} className={`progress-soft progress-md`} role="progressbar" now={item.progress} />
                  </Fragment>
                ))
              }
            </div>
        ...
        <CardTitle as={'h4'} className="mt-3 pt-2"> Experience :</CardTitle>
        <Row className="g-3 mt-1">
          {
            experienceData.map((item, idx) => (
              <Col xl={6} lg={12} key={idx}>
                <div className="d-flex flex-wrap p-2 align-items-center rounded gap-3 border">
                  <Image src={item.image} alt='profile' className="avatar-xl" />
                  <div>

...
const UploadPhotoCard = () => {
  return (
    <FileUpload title="Upload Profile Photo" />
  )
}
  ...
  return (
    <Card>
      <CardHeader className="border-bottom border-dashed">
        <CardTitle as={'h4'} className="mb-0">Doctor Availability</CardTitle>
      </CardHeader>
      <CardBody>
        <Row>
        ...
        <Row className="g-3">
          <Col lg={6}>
            <div>
              <label htmlFor="from-time" className="form-label fw-semibold">From Time:</label>
              <CustomFlatpickr
          ...
          <Col lg={6}>
            <div>
              <label htmlFor="to-time" className="form-label fw-semibold">To Time:</label>
              <CustomFlatpickr
                className="form-control"
                placeholder="12:00 PM"
                options={{
          ...
          <Col lg={12}>
            <div>
              <label htmlFor="dateSelect" className="form-label fw-semibold">Available Date:</label>
              <CustomFlatpickr
                className="form-control"
      ...
      <form onSubmit={handleSubmit(() => { })}>
        <Row>
          <Col lg={7}>
            <Card>
              <CardHeader className="border-bottom border-dashed">
                <CardTitle as={'h4'} className="mb-0">Basic information</CardTitle>
              </CardHeader>
              <CardBody>
                <Row>
                  <Col lg={6}>

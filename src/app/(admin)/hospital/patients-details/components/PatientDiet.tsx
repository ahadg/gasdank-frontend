...
const PatientStatisticCard = () => {
  ...
  return (
    <Card>
      <CardHeader className="border-bottom border-dashed">
        <div className="d-flex align-items-center gap-2">
          <div className="d-block">
            <CardTitle as={'h4'} className="mb-0">Patient Statistic</CardTitle>
          </div>
          <div className="ms-auto">
            <Dropdown align={'end'}>
              <DropdownToggle as={'a'} className="btn btn-sm btn-soft-primary drop-arrow-none" data-bs-toggle="dropdown" aria-expanded="false">
                This Month
              </DropdownToggle>
      ...
      <CardBody>
        <ReactApexChart height={232} options={PatientStatisticChartOpts} series={PatientStatisticChartOpts.series} type="donut" className="apex-charts" />
        <div className="mt-4">
  ...
  return (
    <Card>
      <CardHeader className="border-bottom border-dashed">
        <div className="d-flex align-items-center gap-2">
          <div className="d-block">
            <CardTitle as={'h4'} className="mb-0">Diet</CardTitle>
          </div>
          <div className="ms-auto">
            <Button variant="soft-primary" size="sm">Add Note</Button>
          </div>
        </div>
      </CardHeader>
      <CardBody>
        <Row className="g-2">
          <Col lg={6}>
            <div className="d-flex p-2 rounded align-items-center gap-2 border">
              ...
              <div>
                <p className="text-muted fw-medium mb-0 fs-14"><span className="fw-medium text-dark">8 Glass Water -</span>Per day</p>
              </div>
            </div>
          </Col>
          <Col lg={6}>
            <div className="d-flex p-2 rounded align-items-center gap-2 border">
              ...
              <div>
                <p className="text-muted fw-medium mb-0 fs-14"><span className="fw-medium text-dark">3 Black Tea -</span>Per day</p>
              </div>
            </div>
          </Col>
        </Row>

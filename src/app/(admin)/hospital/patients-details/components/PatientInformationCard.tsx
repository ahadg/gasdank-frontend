  ...
  return (
    <Card>
      <CardHeader className="border-bottom border-dashed">
        <CardTitle as={'h4'} className="mb-0">Patient Information</CardTitle>
      </CardHeader>
      <CardBody>
        ...
        <Row className="mt-2 g-2">
          <Col lg={2} xs={6}>
            ...
            <p className="mb-0 text-muted">BIM <span className="text-success fw-medium"><IconifyIcon icon="tabler:arrow-down" />10</span></p>
          </Col>
          <Col lg={2} xs={6}>
            <h3 className="fw-medium">70 <span className="text-muted fs-15">kg</span></h3>
            <p className="mb-0 text-muted">Weight <span className="text-success fw-medium"><IconifyIcon icon="tabler:arrow-down" />13 kg</span></p>
          </Col>
          <Col lg={2} xs={6}>
            <h3 className="fw-medium">175 <span className="text-muted fs-15">cm</span></h3>
            <p className="mb-0 text-muted">Height</p>
          </Col>
          <Col lg={2} xs={6}>
            <h3 className="fw-medium">124/80</h3>
            <p className="mb-0 text-muted">Blood Pressure <span className="text-danger fw-medium"><IconifyIcon icon="tabler:arrow-up" />12</span></p>
          </Col>
        </Row>
      </CardBody>
    </Card>

      ...
      <CardHeader className="border-bottom border-dashed">
        <div className="d-flex align-items-center gap-2">
          <div className="d-block">
            <CardTitle as={'h4'} className="mb-0">Check Up File</CardTitle>
          </div>
      ...
      <CardBody>
        {
          checkFilesData.map((item, idx) => (
            <div className={`d-flex p-2 rounded align-items-center gap-2 bg-light-subtle border border-dashed ${idx != 0 && 'mt-2'}`} key={idx}>
              ...
              <div className="d-block">
                <Link href="" className="text-dark fw-medium">{item.name}</Link>

    ...
    <Card>
      <CardBody>
        <div className="d-flex align-items-center gap-2">
          <Image src={avatar5} alt='avatar' className="avatar-xl rounded-circle border border-light border-2" />
          <div>
      ...
      <CardFooter className="border-top border-dashed gap-1 hstack">
        <Button variant="primary" className="w-100">Open Chat</Button>
        <Button variant="light" className="w-100">Call Patient</Button>

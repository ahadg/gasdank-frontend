...
const SolarIconsCard = ({ title, icon }: SolarIconType) => {
  return (
    <OverlayTrigger placement="top" overlay={<Tooltip>{title}</Tooltip>}>
      <Card>
        <CardBody className="d-flex flex-column align-items-center justify-content-center" data-bs-toggle="tooltip"
  ...
  return (
    <>
        ...
        <Col xs={12}>
          <Card>
            <CardBody>
              ...
              <p className="mb-4 text-muted">Our cutting-edge Solar Iconset boasts an extensive collection of over 7,477
                glyphs, encompassing a diverse range of design variants, all conveniently packed into a single font
                file</p>
      ...
      <div className="my-3 text-center">
        <Link href="https://icon-sets.iconify.design/solar/" target="_blank" className="btn btn-danger">View All
          Icons</Link>
      </div>
    </>
  )

  ...
  return (
    <ComponentContainerCard title='Disabled Item' description={<>Add <code>.disabled</code> to items in the dropdown to
      ...
      <Dropdown className="btn-group">
        ...
        <DropdownMenu>
          <DropdownItem className="dropdown-item" href="#">Regular link</DropdownItem>
          <DropdownItem className="dropdown-item disabled" href="#" tabIndex={-1} aria-disabled="true">Disabled link</DropdownItem>
          <DropdownItem className="dropdown-item" href="#">Another link</DropdownItem>
        </DropdownMenu>
      </Dropdown>
    </ComponentContainerCard>
  )
    ...
    <ComponentContainerCard title='Dark dropdowns' description={<>Opt into darker dropdowns to match a dark navbar or custom style
      ...
      <Dropdown>
        ...
        <DropdownMenu data-bs-theme="dark">
          <li><DropdownItem className="active" href="#">Action</DropdownItem></li>
          <li><DropdownItem href="">Another action</DropdownItem></li>
          <li><DropdownItem href="">Something else here</DropdownItem></li>
          <li>
            <DropdownDivider />
          </li>
          <li><DropdownItem href="">Separated link</DropdownItem></li>
        </DropdownMenu>
      </Dropdown>
    </ComponentContainerCard>
  )
    ...
    <ComponentContainerCard title='Active Item' description={<>Add <code>.active</code> to item in the dropdown to <strong>style
      ...
      <Dropdown className="btn-group">
        ...
        <DropdownMenu>
          ...
          <DropdownItem className="active" href="#">Active link</DropdownItem>

    ...
    <Card>
      ...
      <CardBody>
        <p className="text-muted">
          ...
          Please read the official <Link target="_blank"
                                         href="https://getbootstrap.com/docs/5.3/components/breadcrumb/">Bootstrap</Link>
      ...
      <CardBody>
        ...
        <nav aria-label="breadcrumb">
          <Breadcrumb className="bg-light bg-opacity-50 p-2 mb-2">
            <BreadcrumbItem><IconifyIcon icon="tabler:smart-home"
                                         className="fs-16 me-1" />Home</BreadcrumbItem>

...
const SignupPage = () => {
  ...
  const handleFinalSignup = async () => {
    ...
    try {
      ...
      let userres = await api.post('/api/users/signup', payload)
      console.log("userres",userres)
      // 2. Now create Stripe Checkout Session
          ...
          <Card className="shadow-lg border-0 rounded-4 p-4 text-center">
            ...
            <div className="d-flex justify-content-center gap-4 mb-4">
              <div className="text-center">
                <div
                  className={`rounded-circle border d-flex justify-content-center align-items-center mx-auto shadow-sm ${
                ...
                <div className="small mt-2 fw-semibold text-muted">User Info</div>
              </div>
              <div className="text-center">
                <div
                  className={`rounded-circle border d-flex justify-content-center align-items-center mx-auto shadow-sm ${
                ...
                <div className="small mt-2 fw-semibold text-muted">Select Plan</div>
              </div>
            </div>
              ...
              {currentStep === 1 && (
                <>
                  ...
                  <div className="d-grid mb-2">
                    <Button type="submit" className="btn btn-primary py-2 fw-semibold">Next</Button>
                  </div>
                </>
              )}
            </Form>
              ...
              <>
                ...
                {plans.length > 0 ? (
                    plans.map((plan) => {
                        ...
                        <Card
                            key={plan.name}
                            className={`mb-3 p-4 rounded-4 shadow-sm ${
